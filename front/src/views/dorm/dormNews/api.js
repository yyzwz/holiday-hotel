...
export const getDynamic_newList = (params) => {
    return getRequest('/dormitoryNews/getByPage', params)
}
// 添加
export const addDynamic_new = (params) => {
    return postRequest('/dormitoryNews/insertOrUpdate', params)
}
// 编辑
...
export const deleteDynamic_new = (params) => {
    return postRequest('/dormitoryNews/delByIds', params)
}

// 设置置顶
export const setTopById = (params) => {
    return postRequest('/dormitoryNews/set_top_by_id', params)
}

// 设置公开
export const setPublicById = (params) => {
    return postRequest('/dormitoryNews/set_public_by_id', params)
}