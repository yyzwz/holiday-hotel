    ...
    <Card>
        ...
        <Form ref="form" :model="form" :label-width="100" :rules="formValidate" label-position="left">
            ...
            <FormItem label="新闻时效" prop="periodTime">
                <DatePicker ref="myDatePicker" :editable="false" type="datetimerange" format="yyyy-MM-dd HH:mm:ss" @on-change="changeServiceDate" style="width: 570px" :value="form.periodTime"></DatePicker>
            </FormItem>
            ...
            <FormItem label="图片" prop="photo">
                <upload-pic-input readonly v-model="form.photo" style="width: 570px"></upload-pic-input>
            </FormItem>
            <Form-item class="br">
