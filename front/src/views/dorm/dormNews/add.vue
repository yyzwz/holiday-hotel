...
<div>
    <Card>
        ...
        <Form ref="form" :model="form" :label-width="120" :rules="formValidate" label-position="right">
            ...
            <FormItem label="新闻时效" prop="periodTime">
                <DatePicker :editable="false" type="datetimerange" format="yyyy-MM-dd HH:mm:ss" @on-change="changeServiceDate" style="width: 570px"></DatePicker>
