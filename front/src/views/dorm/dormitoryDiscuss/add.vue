<template>
  <div>
    <Card>
      ...
      <Form ref="form" :model="form" :label-width="100" :rules="formValidate" label-position="left" >          <FormItem label="宿舍名称" prop="dormitoryName"  >
...
<script>
import { addDormitoryDiscuss } from "./api.js";
export default {
  name: "add",
  components: {
    },
